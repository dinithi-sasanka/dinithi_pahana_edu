...
<head>
    ...
    <title>Low Stock Items Report - Admin</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="table-area">
            ...
            <h2 style="color: #232b3e; margin-bottom: 20px; text-align: center;"><i class="fa fa-exclamation-triangle"></i> Low Stock Items Report</h2>
            <table>
                <thead>
                    <tr>
                        <th>Item ID</th>
                ...
                <% } if (lowStockItems.isEmpty()) { %>
                   <tr><td colspan="3" style="text-align: center; color: #666; font-style: italic;">No low stock items.</td></tr>
                <% } %>
                </tbody>
            </table>
        </div>
