...
<head>
    ...
    <title>Top Customer Report - Admin</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="table-area">
            ...
            <h2 style="color: #232b3e; margin-bottom: 20px; text-align: center;"><i class="fa fa-user-tie"></i> Top Customer Report</h2>
            <table>
                <thead>
                    <tr>
                        <th>Customer ID</th>
                ...
                <% } if (topCustomers.isEmpty()) { %>
                   <tr><td colspan="4" style="text-align: center; color: #666; font-style: italic;">No data available.</td></tr>
                <% } %>
                </tbody>
            </table>
        </div>
