...
<body>
    <div class="sidebar">
        <h2>Staff</h2>
        <ul>
            <li><a href="dashboard_staff.jsp"><i class="fa fa-chart-line"></i> Dashboard</a></li>
    ...
    <div class="main-content">
        ...
        <div style="text-align:center; margin-top:24px;">
            <a href="addCustomer_staff.jsp" style="display:inline-block; background:#1976d2; color:#fff; font-weight:600; border:none; border-radius:8px; font-size:1.08em; text-decoration:none; padding:12px 32px; transition:background 0.2s; box-shadow:0 2px 8px #0001;">
