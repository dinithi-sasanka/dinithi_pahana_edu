...
<html>
<head>
    <title>View Customer Account (Admin)</title>
...
<body>
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="viewCustomerAccount_admin.jsp"><i class="fa fa-id-card"></i> View Account</a></li>
    ...
    $(function() {
        ...
        $('#loadCustomerBtn').click(function() {
            ...
            // Redirect to viewCustomerAccount with search parameter
