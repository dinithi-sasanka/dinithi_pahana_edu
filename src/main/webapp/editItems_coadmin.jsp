...
<%
    ...
    if (item == null) {
        response.sendRedirect("viewItems_coadmin.jsp");
        return;
    }
%>
<!DOCTYPE html>
...
<body>
    ...
    <div class="main-content">
        <div style="display: flex; justify-content: flex-start; margin-bottom: 12px;">
            <a href="viewItems_coadmin.jsp" style="background:#1976d2; color:#fff; font-weight:600; border:none; border-radius:5px; padding:10px 22px; font-size:1.08em; text-decoration:none; transition:background 0.2s;">Back to View Items</a>
        </div>
        <div class="header">
            <div>
